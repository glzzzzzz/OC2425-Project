...
class Player(pygame.sprite.Sprite):
    ...
    def check_contact(self):
        ...
        self.on_surface['right'] = True if right_rect.collidelist(colide_rects) >= 0 else False
        self.on_surface['left'] = True if left_rect.collidelist(colide_rects) >= 0 else False
